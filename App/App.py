...
def course_recommender(course_list):
    st.subheader("**Courses and Certificates Recommendations 👨‍🎓**")
    c = 0
    rec_course = []
...
def run():
    ...
    # Image loading code
    import os
    #logo_path = os.path.join(os.path.dirname(__file__), 'Logo', 'RESUM.png')
 ...
 # Clean Branding & Live Visitor Counter
    st.sidebar.markdown("### Built with 🤍 by **Rudra Pandey**")
    st.sidebar.markdown("[![GitHub](https://img.shields.io/badge/GitHub-Profile-blue?style=flat&logo=github)](https://github.com/rudrapandey2005)")
    st.sidebar.markdown("**Visitors:** ![Visitors](https://visitor-badge.laobi.icu/badge?page_id=rudrapandey2005.AI-Resume-Analyzer)")



    ###### Creating Database and Table ######

    db_sql = """CREATE TABLE IF NOT EXISTS user_data (
    ...
    # Safe Check: Agar cursor available hai tabhi query chalao
    if cursor:
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: grey;">Rudra Pratap Pandey</a> through 
